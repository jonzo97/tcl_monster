# Exporting Component Description of PF_PCIE_EP_X1 to TCL
# Auto-generated by PCIe Configuration Generator
# Configuration: Endpoint, x1 lanes, Gen1 (2.5 Gbps)
# BAR0: 4 KB, Device ID: 0x1556
# Family: PolarFire or PolarFireSoC
create_and_configure_core -core_vlnv {Actel:SgCore:PF_PCIE:*} -component_name {PF_PCIE_EP_X1} -params {\
...
"XT_ES_DEVICE:false"   }
# Exporting Component Description of PF_PCIE_EP_X1 to TCL done
