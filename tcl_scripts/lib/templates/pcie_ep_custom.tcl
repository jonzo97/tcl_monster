# Exporting Component Description of PF_PCIE_CUSTOM to TCL
# Auto-generated by PCIe Configuration Generator
# Configuration: Endpoint, x2 lanes, Gen1 (2.5 Gbps)
# BAR0: 256 KB, Device ID: 0xABCD
# Family: PolarFire or PolarFireSoC
create_and_configure_core -core_vlnv {Actel:SgCore:PF_PCIE:*} -component_name {PF_PCIE_CUSTOM} -params {\
...
"UI_PCIE_0_MASTER_SIZE_BAR_0_TABLE:256 KB"  \
...
"XT_ES_DEVICE:false"   }
# Exporting Component Description of PF_PCIE_CUSTOM to TCL done
